...
insertNewExpense(e) {
      axios.post('/insert',
        querystring.stringify({
          ...
          isGoing: e.state.isGoing,
          isGoing2: e.state.isGoing2
        }), {
          headers: {
...
if (e.target.name == "milestones") {
  ...
  handleInputChange(e) {
    ...
    const name = target.name;
      ...
      if (e.target.name == "isGoing") {
        this.setState({
          isGoing: value
        });
      }
      
    if (e.target.name == "isGoing2") {
        this.setState({
          isGoing2: value
        });
      }
   ...
   if(this.state.messageFromServer == ''){
    ...
    <fieldset>
       ...
       <label htmlFor="milestones">Milestones:</label>
          <input type="milestones" id="milestones" name="milestones" value={this.state.milestones} onChange={this.handleTextChange}></input>
